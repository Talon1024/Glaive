...
pub fn show_window<CE>(win: &Window, _el: &EventLoopWindowTarget<CE>, _ctxr: DrawingContextRequest) -> (WindowContext, Arc<Context>) {
...
pub async fn save_file(contents: Vec<u8>, fname: &str) {
